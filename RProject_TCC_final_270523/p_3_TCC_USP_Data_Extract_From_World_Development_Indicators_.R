...
pprimeiroquartil <- final_dataset
...
options(scipen = 999)
xiqr_9 <- as.matrix(iqr_9)
tterceiroquartil <- final_dataset
...
## Salvando as medidas de tendencia e dispersão:
...
## Visualizando os dados de tendência e dispersao:
library(dplyr)
library(knitr)
library(kableExtra)
dev.off()
